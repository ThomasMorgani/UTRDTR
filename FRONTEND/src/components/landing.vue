  ...
  <div class="uk-flex uk-flex-column uk-flex-middle uk-height-1-1">
    ...
    <transition name="fadeInLeftBig">
      <div
        ...
        style="background-image: url(http://localhost:3000/images/beer_animated.gif); max-width: 90vw;"
      >
        <div class="uk-container ">
          ...
          >
            ...
            <div class="uk-margin uk-width-1-1" v-if="action === 'join'">
              <label
                class="uk-form-label uk-text-bold uk-align-left"
                for="gameId"
                >GAME ID</label
            ...
            <div class="uk-margin uk-width-1-1" v-else>
              <label
                class="uk-form-label uk-text-bold uk-align-left"
                for="gamePin"
                >MAX PLAYERS</label
    ...
    <div
      class="uk-padding-small uk-flex uk-flex-inline  uk-flex-center  uk-flex-middle uk-width-1-1"
    >
      OR
    </div>
    <button
